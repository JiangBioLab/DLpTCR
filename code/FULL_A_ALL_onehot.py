...
modelfile = './model/FULL_A_ALL_onehot_plt_{}.h5'.format(1)
history = FULL_onehot(modelfile,0.3,100,64)
print(history.history.keys())

# summarize history for accuracy
plt.plot(history.history['val_accuracy'], 'red', label='Test acc')
...
# summarize history for accuracy
plt.plot(history.history['accuracy'], 'red', label='Test acc')
plt.title('model accuracy')
plt.ylabel('Test accuracy')
plt.xlabel('Epoch')
plt.show()
