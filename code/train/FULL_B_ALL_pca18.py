...
csvFile = open("FULL_B_ALL_pca18_test_ACC.csv", "w" , newline='')
csv_writer= csv.writer(csvFile)


for model_number in range(50):
    print(model_number)
    modelfile = './model/FULL_B_ALL_pca18_plt_{}.h5'.format(model_number)
    history = FULL_pca18(modelfile,0.3,300,128,18)
...
csvFile = open("FULL_B_ALL_pca18_result1.csv", "w" , newline='')
csv_writer = csv.writer(csvFile)
