...
#测试集
def FULL_onehot(Dropout1=0,Epochs= 20,Batch_size=64):
    # 优化器选择 Adam 优化器。
    ...
    Feature_test = np.load("../../data_625/TCRA_train_feature_array.npy")    
    Label_array = np.load("../../data_625/TCRA_train_label_array.npy")
