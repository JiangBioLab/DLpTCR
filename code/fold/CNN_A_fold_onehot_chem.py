...
#测试集
def CNN_onehot_chem(Dropout1=0,Epochs= 20,Batch_size=64):
    # 优化器选择 Adam 优化器。
    ...
    Feature_test = np.load("../../data/TCRA_train_feature_array.npy")    
    Label_array = np.load("../../data/TCRA_train_label_array.npy")
...
#             tf.keras.layers.MaxPooling2D(2,2),
            ...
            tf.keras.layers.Conv2D(64, (5,5),padding = 'same', input_shape=(29,20,2),activation='relu'),            
            #tf.keras.layers.LeakyReLU(alpha=0.05),
            #tf.keras.layers.MaxPooling2D(2,2),
